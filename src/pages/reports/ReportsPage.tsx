...
export function ReportsPage() {
  ...
  const handleExport = () => {
    toast(
      "info",
      "Export coming soon",
      "Export feature is not yet available in this prototype",
    );
  };
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center justify-between mb-4">
            ...
            <button
              ...
              className="flex items-center gap-1 text-xs text-gray-500 border border-gray-200 px-2 py-1 rounded hover:bg-gray-50"
            >
        ...
        {/* CSW Visit Completion */}
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="flex items-center justify-between mb-4">
            <h3 className="font-semibold text-gray-900">
              CSW Visit Completions by Week
            </h3>
            <button
              onClick={handleExport}
              className="flex items-center gap-1 text-xs text-gray-500 border border-gray-200 px-2 py-1 rounded hover:bg-gray-50"
